...
# Device etc
PRODUCT_COPY_FILES := \
    device/sony/seagull/rootdir/system/vendor/etc/mixer_paths.xml:system/vendor/etc/mixer_paths.xml \
    device/sony/seagull/rootdir/system/etc/sensors/sensor_def_qcomdev.conf:system/etc/sensors/sensor_def_qcomdev.conf \
    device/sony/seagull/rootdir/system/etc/thermal-engine-8226.conf:system/etc/thermal-engine-8226.conf \
...
# Sensors
PRODUCT_COPY_FILES += \
    device/sony/seagull/rootdir/system/etc/_hals.conf:system/vendor/etc/sensors/_hals.conf
